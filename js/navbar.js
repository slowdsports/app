...
let navbarIconF1 = `
<a class="nav-bar-icon" href="javascript:void(0)">
    <i class="blancolor uil uil-car"></i>
</a>
`;
let navbarIconMotoGP = `
<a class="nav-bar-icon" href="javascript:void(0)">
    <i class="blancolor il uil-metro"></i>
</a>
`;
let navbarIconTennis = `
<a class="nav-bar-icon" href="javascript:void(0)">
    <i class="blancolor uil uil-table-tennis"></i>
</a>
`;
let navbarIconNFL = `
<a class="nav-bar-icon" href="javascript:void(0)">
...
`;
let navbarIconResumen = `
<a class="nav-bar-icon" href="javascript:void(0)">
    <i class="blancolor uil uil-video"></i>
</a>
`;
let navbarLogo = `
...
for(const ele of document.getElementsByClassName("navbar-icon-home")){ele.innerHTML=(navbarIconHome)};
for(const ele of document.getElementsByClassName("navbar-icon-futbol")){ele.innerHTML=(navbarIconFutbol)};
for(const ele of document.getElementsByClassName("navbar-icon-basket")){ele.innerHTML=(navbarIconBasket)};
...
for(const ele of document.getElementsByClassName("navbar-icon-f1")){ele.innerHTML=(navbarIconF1)};
...
for(const ele of document.getElementsByClassName("navbar-icon-resumen")){ele.innerHTML=(navbarIconResumen)};
