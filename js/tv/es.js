...
<div class="card darkolorbg text-white card-canal">
       <a class="card-link text-white" href="go:amces">           
        <div class="card-body">
            <div class="d-flex justify-content-center">
                <img class="canal-img amc" src="https://i.ibb.co/w0qg9JF/trans.png" alt="">
            </div>
            
            <div class="d-flex justify-content-center"><h5>AMC <i class="flag es"></i></h5></div>
        </div>
       </a>
    </div>
`
...
<div class="card darkolorbg text-white card-canal">
       <a class="card-link text-white" href="go:beinne">           
        <div class="card-body">
            ...
            <div class="d-flex justify-content-center"><h5>BeIN <i class="flag mx"></i></h5></div>
        </div>
       </a>
    </div>
`
...
<div class="card darkolorbg text-white card-canal">
       <a class="card-link text-white" href="go:otro1">           
        <div class="card-body">
            ...
            <div class="d-flex justify-content-center"><h5>BeMad!</h5></div>
        </div>
       </a>
    </div>
`
...
<div class="card darkolorbg text-white card-canal">
       <a class="card-link text-white" href="go:cuatrob">           
        <div class="card-body">
            ...
            <div class="d-flex justify-content-center"><h5>Cuatro</h5></div>
        </div>
       </a>
    </div>
`
...
let DiscoveryCes = `
<div class="card darkolorbg text-white card-canal">
       <a class="card-link text-white" href="go:dces">           
        <div class="card-body">
            <div class="d-flex justify-content-center">
                <img class="canal-img discovery" src="https://i.ibb.co/w0qg9JF/trans.png" alt="">
            </div>
            
            <div class="d-flex justify-content-center"><h5><span class="hidden"> discovery</span> Channel <i class="flag es"></i></h5></div>
        </div>
       </a>
    </div>
`
for(const ele of document.getElementsByClassName("tv-discoveryces")){ele.innerHTML=(DiscoveryCes)};
...
<div class="card darkolorbg text-white card-canal">
       <a class="card-link text-white" href="go:esport3">           
        <div class="card-body">
            <div class="d-flex justify-content-center">
                <img class="canal-img esport3" src="https://i.ibb.co/w0qg9JF/trans.png" alt="">
            </div>
            
            <div class="d-flex justify-content-center"><h5>ESport3</h5></div>
        </div>
       </a>
    </div>
`
...
<div class="card darkolorbg text-white card-canal">
       <a class="card-link text-white" href="go:eurosport1">           
        <div class="card-body">
            ...
            <div class="d-flex justify-content-center"><h5>EuroSport</h5></div>
        </div>
       </a>
    </div>
`
...
let FOXes = `
<div class="card darkolorbg text-white card-canal">
       <a class="card-link text-white" href="go:foxes">           
        <div class="card-body">
            <div class="d-flex justify-content-center">
                <img class="canal-img fox" src="https://i.ibb.co/w0qg9JF/trans.png" alt="">
            </div>
            
            <div class="d-flex justify-content-center"><h5>FOX <i class="flag es"></i></h5></div>
        </div>
       </a>
    </div>
`
...
<div class="card darkolorbg text-white card-canal">
       <a class="card-link text-white" href="go:toros">           
        <div class="card-body">
            <div class="d-flex justify-content-center">
                <img class="canal-img toros" src="https://i.ibb.co/w0qg9JF/trans.png" alt="">
            </div>
...
<div class="card darkolorbg text-white card-canal">
       <a class="card-link text-white" href="go:telecincob">           
        <div class="card-body">
            ...
            <div class="d-flex justify-content-center"><h5>Telecinco</h5></div>
        </div>
       </a>
    </div>
`
...
let TNTes = `
<div class="card darkolorbg text-white card-canal">
       <a class="card-link text-white" href="go:tntes">           
        <div class="card-body">
            <div class="d-flex justify-content-center">
                <img class="canal-img tnt" src="https://i.ibb.co/w0qg9JF/trans.png" alt="">
            </div>
            
            <div class="d-flex justify-content-center"><h5>TNT <i class="flag es"></i></h5></div>
        </div>
       </a>
    </div>
`
