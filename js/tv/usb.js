let tituloUS = `
<h4 class="text-white">Canales de USA <i class="flag us"></i></h4>
`
for(const ele of document.getElementsByClassName("titulo-us")){ele.innerHTML=(tituloUS)};
...
`
for(const ele of document.getElementsByClassName("tv-canales-us")){ele.innerHTML=(canalesTVUS)};