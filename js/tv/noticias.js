let tituloNoticias = `
<h4 class="text-white">Canales de Noticias</h4>
`
for(const ele of document.getElementsByClassName("titulo-noticias")){ele.innerHTML=(tituloNoticias)};

// CANALES RECOPILADOS BRASIL

let canalesTVNoticias = `
...
`
for(const ele of document.getElementsByClassName("tv-canales-noticias")){ele.innerHTML=(canalesTVNoticias)};