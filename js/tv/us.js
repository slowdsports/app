...
<div class="card darkolorbg text-white card-canal">
       <a class="card-link text-white" href="go:beinxtra">           
        <div class="card-body">
            ...
            <div class="d-flex justify-content-center"><h5>BeIN Xtra <i class="flag us"></i></h5></div>
        </div>
       </a>
    </div>
`
...
<div class="card darkolorbg text-white card-canal">
       <a class="card-link text-white" href="go:espnus">           
        <div class="card-body">
            ...
            <div class="d-flex justify-content-center"><h5>ESPN <i class="flag us"></i></h5></div>
        </div>
       </a>
    </div>
`
for(const ele of document.getElementsByClassName("tv-espnus")){ele.innerHTML=(ESPNUS)};

let ESPN2US = `
<div class="card darkolorbg text-white card-canal">
       <a class="card-link text-white" href="go:espn2us">           
        <div class="card-body">
            <div class="d-flex justify-content-center">
                <img class="canal-img espn" src="https://i.ibb.co/w0qg9JF/trans.png" alt="">
            </div>
            
            <div class="d-flex justify-content-center"><h5>ESPN 2 <i class="flag us"></i></h5></div>
        </div>
       </a>
    </div>
`
for(const ele of document.getElementsByClassName("tv-espn2us")){ele.innerHTML=(ESPN2US)};

let ESPNU = `
<div class="card darkolorbg text-white card-canal">
       <a class="card-link text-white" href="go:espnu">           
        <div class="card-body">
            <div class="d-flex justify-content-center">
                <img class="canal-img espn" src="https://i.ibb.co/w0qg9JF/trans.png" alt="">
            </div>
            
            <div class="d-flex justify-content-center"><h5>ESPN U <i class="flag us"></i></h5></div>
        </div>
       </a>
    </div>
`
for(const ele of document.getElementsByClassName("tv-espnu")){ele.innerHTML=(ESPNU)};

let ESPNNews = `
<div class="card darkolorbg text-white card-canal">
       <a class="card-link text-white" href="go:espnnews">           
        <div class="card-body">
            <div class="d-flex justify-content-center">
                <img class="canal-img espn" src="https://i.ibb.co/w0qg9JF/trans.png" alt="">
            </div>
...
`
for(const ele of document.getElementsByClassName("tv-fsus")){ele.innerHTML=(FSUS)};

let FS2US = `
<div class="card darkolorbg text-white card-canal">
       <a class="card-link text-white" href="go:fs2us">           
        <div class="card-body">
            <div class="d-flex justify-content-center">
                <img class="canal-img foxsports" src="https://i.ibb.co/w0qg9JF/trans.png" alt="">
            </div>
...
`
for(const ele of document.getElementsByClassName("tv-fs2us")){ele.innerHTML=(FS2US)};

let FSNews = `
<div class="card darkolorbg text-white card-canal">
       <a class="card-link text-white" href="go:fsnews">           
        <div class="card-body">
            <div class="d-flex justify-content-center">
                <img class="canal-img foxsports" src="https://i.ibb.co/w0qg9JF/trans.png" alt="">
            </div>
...
let MSNBC = `
<div class="card darkolorbg text-white card-canal">
       <a class="card-link text-white" href="go:msnbc">           
        <div class="card-body">
            <div class="d-flex justify-content-center">
                <img class="canal-img nbc" src="https://i.ibb.co/w0qg9JF/trans.png" alt="">
            </div>
            
            <div class="d-flex justify-content-center"><h5>MSNBC </h5></div>
        </div>
       </a>
    </div>
`
