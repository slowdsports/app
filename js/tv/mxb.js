let tituloMX = `
<h4 class="text-white">Canales de Italia <i class="flag mx"></i></h4>
`
for(const ele of document.getElementsByClassName("titulo-mx")){ele.innerHTML=(tituloMX)};
...
`
for(const ele of document.getElementsByClassName("tv-canales-mx")){ele.innerHTML=(canalesTVMX)};