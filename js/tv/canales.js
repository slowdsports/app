...
for(const ele of document.getElementsByClassName("espnu")){ele.innerHTML=(espnu)};
for(const ele of document.getElementsByClassName("espnnews")){ele.innerHTML=(espnnews)};
for(const ele of document.getElementsByClassName("espnsec")){ele.innerHTML=(espnsec)};
...
for(const ele of document.getElementsByClassName("fs2sur")){ele.innerHTML=(fs2sur)};
...
for(const ele of document.getElementsByClassName("univisione")){ele.innerHTML=(univisione)};
...
for(const ele of document.getElementsByClassName("vtvhn")){ele.innerHTML=(vtvhn)};
