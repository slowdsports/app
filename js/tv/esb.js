let tituloES = `
<h4 class="text-white">Canales de España <i class="flag es"></i></h4>
`
for(const ele of document.getElementsByClassName("titulo-es")){ele.innerHTML=(tituloES)};
...
`
for(const ele of document.getElementsByClassName("tv-canales-es")){ele.innerHTML=(canalesTVES)};