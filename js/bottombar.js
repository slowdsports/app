let bottombarHome = `
    <div id="myMenu" class="altmenu">
      ...
      <ul style="margin-bottom: 1%;" class="list-group-horizontal">
        ...
        <i class="blancolormenu bottom-icon uil-estate activo"></i>
...
for(const ele of document.getElementsByClassName("navbar-bottom-tv")){ele.innerHTML=(bottombarTv)};
for(const ele of document.getElementsByClassName("navbar-bottom-info")){ele.innerHTML=(bottombarInfo)};